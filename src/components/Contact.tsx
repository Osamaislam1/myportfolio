    ...
    const contactInfo = [
        {
            ...
            label: 'email',
            value: 'osama.islam29@gmail.com',
            href: 'mailto:osama.islam29@gmail.com',
        },
        {
            ...
            >
                ...
                >
                    <div className="flex items-center gap-2 mb-4 font-mono text-sm">
                        ...
                        <span className="text-white">ssh connect@osama.dev</span>
                    </div>
