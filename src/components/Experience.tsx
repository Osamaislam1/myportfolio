  ...
  const experiences = [
    {
      ...
      points: [
        "Successfully developed and maintained backend code for over 30+ web applications using Laravel PHP framework",
        ...
        "Integrated payment gateways ensuring secure transaction processing"
      ]
    }
  ];
